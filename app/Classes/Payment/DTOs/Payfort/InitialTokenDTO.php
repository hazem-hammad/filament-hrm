...
class InitialTokenDTO extends AbstractDTO implements InitialTokenDTOInterface
{
    ...
    private $deviceId;  // Stores the device ID
    ...
    final public function toArray(): array
    {
        return [
            ...
            'device_id' => $this->deviceId,   // Maps device ID to array
    ...
    final protected function map(array $data): bool
    {
        ...
        // Assign device ID from input data
    ...
    {
        return $this->deviceId; // Return the device ID
    }
    ...
    {
        return $this->merchantReference; // Return the merchant reference ID
    }
}
