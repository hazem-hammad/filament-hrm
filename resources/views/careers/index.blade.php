...
<body class="antialiased font-sans text-gray-700 bg-gray-100">
    ...
    <section class="relative overflow-visible company-bg pt-12">
        ...
        <div class="mx-auto max-w-7xl px-6 pt-12 lg:px-8 lg:pt-16 relative z-10">
            <!-- Page heading -->
            <div class="flex flex-col items-center text-center">
                <!-- Logo with simplified styling -->
                <div class="relative mb-3 group">
                    <a href="#"
                        class="relative block bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/20 hover:bg-white/20 transition-all duration-300">
                        <img src="{{ get_setting('logo_light', '/images/logos/logo-light.svg') }}"
                            alt="{{ get_setting('company_name') }} logo" class="h-12 w-auto">
                    </a>
                </div>
                ...
                <div class="relative mb-2">
                    <h1 class="text-3xl lg:text-4xl font-bold text-white mb-2 tracking-tight">
                        Careers at {{ get_setting('company_name') }}
                    </h1>
                </div>

                <!-- Simplified subtitle -->
                <p class="max-w-xl text-sm lg:text-base text-white/90 leading-relaxed mb-4">
                    Join our team and build the future of technology together.
                </p>

                <!-- Simplified stats -->
                <div class="hidden md:flex justify-center gap-4 mb-4 text-white/80">
                    <div class="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 text-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">
                            </path>
                        </svg>
                        <span class="font-medium">Remote Friendly</span>
                    </div>
                    <div class="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 text-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span class="font-medium">Fast Growing</span>
                    </div>
                </div>
            </div>

            <!-- Simplified search card -->
            <div class="relative z-10 mt-8 mb-[-2rem] rounded-xl bg-white px-4 py-4 lg:px-6 lg:py-6">
                <form id="job-filter-form" method="GET" action="{{ route('jobs.index') }}">
                    <!-- Compact search and filters in one row -->
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-end">
                        <!-- Search input -->
                        <div class="flex-1">
                            <label for="search" class="sr-only">Search for jobs</label>
                            <div class="relative">
                                <input id="search" name="search" type="text" placeholder="Search jobs..."
                                    value="{{ request('search') }}"
                                    class="w-full rounded-lg border border-gray-300 py-2.5 pl-3 pr-10 text-gray-700 placeholder-gray-400 focus:outline-none company-focus" />
                                <svg class="absolute right-3 top-3 h-4 w-4 text-gray-400" fill="none"
                        ...
                        <button type="button" id="clear-filters"
                            class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2.5 company-bg text-white rounded-lg company-bg-hover transition-all duration-150 font-medium text-sm">
